...
/* Declare this is the fast version of Senna */
#ifndef NO_NFKC
#define FAST_SENNA
#endif /* NO_NFKC */
...
typedef struct _sen_records sen_records;
...
typedef struct _sen_set_sort_optarg sen_set_sort_optarg;
...
/*
sen_set *sen_index_related_terms(sen_index *index, const char *string,
                                 const char *(*fetcher)(void *, void *),
                                 void *fetcher_arg);
*/
...
int fast_sen_str_normalize(const char *str, unsigned int str_len,
						   char *nstrbuf, int buf_size);
